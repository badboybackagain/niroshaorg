(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,47914,77666,e=>{"use strict";let i=[{id:1,slug:"logo-designing-with-numerology-and-astrology",title:"Logo Designing with Numerology and Astrology: Creating Brand Identity Through Cosmic Alignment",excerpt:"Discover how combining numerology and astrology principles with professional logo design can create powerful, meaningful brand identities that resonate with your target audience and align with cosmic energies.",category:"Branding & Design",author:"Team Nirosha",publishDate:"2024-01-15",readTime:"8 min read",featuredImage:"/cache/blog/logo-numerology-astrology-featured.webp",imageAlt:"Logo design incorporating numerology and astrology elements",imageSlug:"logo-numerology-astrology",featured:!0,content:`
    ...
    `,seoTitle:"Cloud & Infrastructure: Complete Guide to Scalable and Secure Solutions in 2025 | Cloud Services",seoDescription:"Master cloud infrastructure with comprehensive guide. Learn about cloud hosting, scalability, security, performance optimization, and how to build robust infrastructure supporting business growth. Expert cloud infrastructure services by Team Nirosha.",seoKeywords:"cloud infrastructure, cloud hosting, cloud services, IaaS, PaaS, cloud computing, cloud migration, cloud security, scalable infrastructure, cloud solutions, cloud hosting services, cloud infrastructure management, cloud architecture, cloud hosting company, cloud services provider, cloud infrastructure services, cloud solutions provider"}];e.s(["blogCategories",0,["Web Development","Branding & Design","SEO Services","Local SEO","Social Media Marketing","Digital Marketing","Content Services","E-commerce Solutions","Web Maintenance","UI/UX Design","Automation & SaaS","Cloud & Infrastructure"],"blogPosts",0,i,"getBlogBySlug",0,e=>i.find(i=>i.slug===e),"getBlogsByCategory",0,e=>i.filter(i=>i.category===e),"getFeaturedBlogs",0,(e=3)=>i.filter(e=>!0===e.featured).sort((e,i)=>new Date(i.publishDate)-new Date(e.publishDate)).slice(0,e)],47914);var t=e.i(43476),r=e.i(71645);e.s(["default",0,({slug:e,size:i="featured",alt:o,className:n=""})=>{let[s,a]=(0,r.useState)(!1),l={thumbnail:{width:400,height:300,sizes:"(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"},featured:{width:1200,height:630,sizes:"(max-width: 768px) 100vw, (max-width: 1200px) 90vw, 1200px"},large:{width:1600,height:900,sizes:"100vw"}},d=l[i]||l.featured,c=e||"logo-numerology-astrology";return s?(0,t.jsx)("div",{className:`blog-image-placeholder ${n}`,children:(0,t.jsx)("span",{children:"Image not available"})}):(0,t.jsxs)("picture",{className:n,children:[(0,t.jsx)("source",{srcSet:`
          /cache/blog/${c}-${i}.webp 1x,
          /cache/blog/${c}-${i}@2x.webp 2x
        `,type:"image/webp",onError:()=>a(!0)}),(0,t.jsx)("source",{srcSet:`
          /cache/blog/${c}-${i}.png 1x,
          /cache/blog/${c}-${i}@2x.png 2x
        `,type:"image/png",onError:()=>a(!0)}),(0,t.jsx)("img",{src:`/cache/blog/${c}-${i}.webp`,alt:o||"Blog image",width:d.width,height:d.height,sizes:d.sizes,loading:"lazy",onError:()=>a(!0),className:"blog-image"})]})}],77666)}]);