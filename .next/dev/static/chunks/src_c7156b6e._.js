...
const GoogleTagManager = ({ gtmId, consentGranted })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GoogleTagManager.useEffect": ()=>{
            if (!gtmId || ("TURBOPACK compile-time value", "object") === 'undefined') return;
            ...
            if (!window.dataLayer.find({
                "GoogleTagManager.useEffect": (item)=>item.event === 'consent'
            }["GoogleTagManager.useEffect"])) {
...
_s(GoogleTagManager, "3ubReDTFssvu4DHeldAg55cW/CI=");
_c = GoogleTagManager;
...
//# sourceMappingURL=src_c7156b6e._.js.map