...
_s(Navbar, "+4TKWax3noz9TaAGl3dQh5Z8p4w=", false, function() {
    return [
...
_s(ConsentBanner, "tZdeELrq4kURZ7UtHXueyU60hHA=");
_c = ConsentBanner;
 ...
 */ const GTMConsentWrapper = ()=>{
    ...
    const gtmId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GTMConsentWrapper.useMemo[gtmId]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            return ("TURBOPACK compile-time value", "G-F4SER380S1") || null;
        }
    }["GTMConsentWrapper.useMemo[gtmId]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            gtmId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GoogleTagManager, {
                gtmId: gtmId,
...
"[project]/src/components/AsyncCSSLoader.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
/**
 * AsyncCSSLoader - Makes all CSS load asynchronously to prevent render blocking
 * Uses the media="print" trick: CSS loads in background, then switches to "all" when loaded
 */ const AsyncCSSLoader = ()=>{
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AsyncCSSLoader.useEffect": ()=>{
            // Function to make stylesheets non-blocking
            const makeCSSAsync = {
                "AsyncCSSLoader.useEffect.makeCSSAsync": ()=>{
                    // Find all stylesheet links that aren't already async
                    const links = document.querySelectorAll('link[rel="stylesheet"]:not([data-async])');
                    links.forEach({
                        "AsyncCSSLoader.useEffect.makeCSSAsync": (link)=>{
                            // Mark as processed
                            link.setAttribute('data-async', 'true');
                            // Use media="print" trick - browser loads it but doesn't block render
                            link.media = 'print';
                            // Switch to "all" when loaded
                            link.onload = ({
                                "AsyncCSSLoader.useEffect.makeCSSAsync": function() {
                                    this.media = 'all';
                                    this.onload = null;
                                }
                            })["AsyncCSSLoader.useEffect.makeCSSAsync"];
                            // Fallback for browsers that don't support onload on link elements
                            // Check if stylesheet is loaded after a short delay
                            setTimeout({
                                "AsyncCSSLoader.useEffect.makeCSSAsync": ()=>{
                                    if (link.media === 'print') {
                                        // Check if stylesheet is actually loaded by checking if it's in document.styleSheets
                                        try {
                                            const sheets = Array.from(document.styleSheets);
                                            const isLoaded = sheets.some({
                                                "AsyncCSSLoader.useEffect.makeCSSAsync.isLoaded": (sheet)=>{
                                                    try {
                                            ...
                                            }["AsyncCSSLoader.useEffect.makeCSSAsync.isLoaded"]);
                                            if (isLoaded) {
                                                link.media = 'all';
                                            } else {
                                                // Force switch after reasonable timeout
                                                setTimeout({
                                                    "AsyncCSSLoader.useEffect.makeCSSAsync": ()=>{
                                                        link.media = 'all';
                                                    }
                                                }["AsyncCSSLoader.useEffect.makeCSSAsync"], 100);
                                            }
                                        } catch (e) {
                                            // If we can't check, just switch to all after delay
                                            link.media = 'all';
                                        }
                                    }
                                }
                            }["AsyncCSSLoader.useEffect.makeCSSAsync"], 50);
                        }
                    }["AsyncCSSLoader.useEffect.makeCSSAsync"]);
                }
            }["AsyncCSSLoader.useEffect.makeCSSAsync"];
...
_s(AsyncCSSLoader, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = AsyncCSSLoader;
const __TURBOPACK__default__export__ = AsyncCSSLoader;
var _c;
__turbopack_context__.k.register(_c, "AsyncCSSLoader");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_70db14f4._.js.map