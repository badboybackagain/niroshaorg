...
"[project]/src/components/LaptopMockup.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const LaptopMockup = ({ imageSrc, alt = "Website Mockup" })=>{
    _s();
    ...
    const [translateY, setTranslateY] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('0px');
    const handleMouseEnter = ()=>{
        if (imageRef.current && containerRef.current) {
            const imageHeight = imageRef.current.offsetHeight;
            const containerHeight = containerRef.current.offsetHeight;
            // Calculate how much to scroll
            // We want to scroll until the bottom of the image meets the bottom of the container
            if (imageHeight > containerHeight) {
                const scrollDistance = imageHeight - containerHeight;
                setTranslateY(`-${scrollDistance}px`);
            }
        }
    };
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            fileName: "[project]/src/components/LaptopMockup.jsx",
                            lineNumber: 31,
                            columnNumber: 21
...
_s(LaptopMockup, "RxehBO/TDC6XCpJ8h9JqfzN3/80=");
_c = LaptopMockup;
const __TURBOPACK__default__export__ = LaptopMockup;
var _c;
__turbopack_context__.k.register(_c, "LaptopMockup");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LaptopMockup$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/LaptopMockup.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const PortfolioPage = ()=>{
    ...
    const [categoryImages, setCategoryImages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    // Safety check for portfolioCategories
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"] || !Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"]) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"].length === 0) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortfolioPage.useEffect": ()=>{
            const loadCategoryImages = {
                "PortfolioPage.useEffect.loadCategoryImages": async ()=>{
                    const imagesMap = {};
                    for (const category of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"]){
                        try {
                            ...
                            if (res.ok) {
                                ...
                                const sorted = images.sort({
                                    "PortfolioPage.useEffect.loadCategoryImages.sorted": (a, b)=>{
                                        const numA = parseInt(a.match(/\d+/)?.[0] || '0');
                                        const numB = parseInt(b.match(/\d+/)?.[0] || '0');
                                        if (numA && numB) return numA - numB;
                                        return a.localeCompare(b);
                                    }
                                }["PortfolioPage.useEffect.loadCategoryImages.sorted"]);
            ...
            }["PortfolioPage.useEffect.loadCategoryImages"];
            loadCategoryImages();
        }
    }["PortfolioPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortfolioPage.useEffect": ()=>{
            ...
            const initAnimations = {
                "PortfolioPage.useEffect.initAnimations": async ()=>{
                    try {
                        const { gsap, ScrollTrigger } = await __turbopack_context__.A("[project]/src/utils/gsapConfig.js [app-client] (ecmascript, async loader)");
                        ctx = gsap.context({
                            "PortfolioPage.useEffect.initAnimations": ()=>{
                                // Title animation
                                if (titleRef.current) {
                        ...
                        }["PortfolioPage.useEffect.initAnimations"], sectionRef);
                    } catch (error) {
                        ...
                        if (gridRef.current) {
                            const items = gridRef.current.querySelectorAll('.portfolio-category-card');
                            items.forEach({
                                "PortfolioPage.useEffect.initAnimations": (item)=>{
                                    item.style.opacity = '1';
                                    item.style.visibility = 'visible';
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container",
                    children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"] && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"].length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "portfolio-categories-grid",
                        ref: gridRef,
                        children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$portfolioData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["portfolioCategories"].map((category)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: hasImages ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "portfolio-category-slideshow",
                                            children: images.map((imageName, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("picture", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                className: "portfolio-website-showcase",
                style: {
                    padding: '4rem 0',
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Explore our web design projects"
                                }, void 0, false, {
                                    fileName: "[project]/src/page-components/PortfolioPage.jsx",
                                    lineNumber: 228,
                                    columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LaptopMockup$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            imageSrc: "/images/portfolio/websites/saharaseats.png",
                            alt: "Sahara Seats Website Design"
                        }, void 0, false, {
                            fileName: "[project]/src/page-components/PortfolioPage.jsx",
                            lineNumber: 233,
                            columnNumber: 11
...
_s(PortfolioPage, "ZVhnQbCudQlwu6jJyoKoHyhqVAg=");
_c = PortfolioPage;
...
//# sourceMappingURL=src_587ba189._.js.map