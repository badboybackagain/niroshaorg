...
const LaptopMockup = ({ imageSrc, alt = "Website Mockup", autoScroll = false, zoom = 1 })=>{
    ...
    const calculateScrollDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LaptopMockup.useCallback[calculateScrollDistance]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LaptopMockup.useEffect": ()=>{
            if (!autoScroll) return;
            let timeoutId;
            let isActive = true;
            const startLoop = {
                "LaptopMockup.useEffect.startLoop": ()=>{
                    if (!isActive) return;
                    ...
                    timeoutId = setTimeout({
                        "LaptopMockup.useEffect.startLoop": ()=>{
                            ...
                            if (distance > 0) {
                                ...
                                }["LaptopMockup.useEffect.startLoop"], 7000);
                            } else {
                                // Image loaded late? Retry
                                timeoutId = setTimeout(startLoop, 1000);
                            }
                        }
                    }["LaptopMockup.useEffect.startLoop"], 1000);
                }
            }["LaptopMockup.useEffect.startLoop"];
...
_s(LaptopMockup, "EiO19N/PrSyCIF0hmEr666RcANU=");
_c = LaptopMockup;
...
//# sourceMappingURL=_10e16971._.js.map