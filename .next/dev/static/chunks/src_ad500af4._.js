...
"[project]/src/components/BlogSchema.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const BlogSchema = ()=>{
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogSchema.useEffect": ()=>{
            const blogUrl = 'https://nirosha.org/blog';
            // Get recent blog posts for the blogPost property (limit to latest 10)
            const recentPosts = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$blogData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["blogPosts"].sort({
                "BlogSchema.useEffect.recentPosts": (a, b)=>new Date(b.publishDate) - new Date(a.publishDate)
            }["BlogSchema.useEffect.recentPosts"]).slice(0, 10).map({
                "BlogSchema.useEffect.recentPosts": (blog)=>{
            ...
            }["BlogSchema.useEffect.recentPosts"]);
            const schema = {
...
_s(BlogSchema, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = BlogSchema;
const __TURBOPACK__default__export__ = BlogSchema;
var _c;
__turbopack_context__.k.register(_c, "BlogSchema");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/utils/categorySlug.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function categoryToSlug(category) {
    return category.toLowerCase().replace(/&/g, 'and') // Replace & with 'and'
...
"[project]/src/page-components/BlogListingPage.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BlogSchema$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/BlogSchema.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$categorySlug$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/categorySlug.js [app-client] (ecmascript)");
;
...
_s(BlogCard, "9bzfpXYnG30yGj0ARWuBbJCUP+Y=", false, function() {
    return [
...
const BlogListingContent = ({ initialCategory = null })=>{
        ...
        "BlogListingContent.useEffect": ()=>{
            if (selectedCategory !== 'All') {
                ...
                const timer = setTimeout({
                    "BlogListingContent.useEffect.timer": ()=>{
                        setTitleMounted(true);
                    }
                }["BlogListingContent.useEffect.timer"], 100);
                return ({
                    "BlogListingContent.useEffect": ()=>clearTimeout(timer)
                })["BlogListingContent.useEffect"];
            } else {
    ...
    const updateURL = (page, category)=>{
        if (category !== 'All') {
            ...
            const categorySlug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$categorySlug$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categoryToSlug"])(category);
            ...
            mainFeatured && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeroFeaturedCard, {
                                blog: mainFeatured
                            }, void 0, false, {
                                fileName: "[project]/src/page-components/BlogListingPage.jsx",
                                lineNumber: 278,
                            ...
                            sideFeatured.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: sideFeatured.map((blog)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeroSideCard, {
                                        blog: blog
                                    }, blog.id, false, {
                                        fileName: "[project]/src/page-components/BlogListingPage.jsx",
                                        lineNumber: 282,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        selectedCategory === 'All' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                            children: paginatedBlogs.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "blog-section",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "blog-grid",
                                                        children: paginatedBlogs.map((blog, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BlogCard, {
                                                                blog: blog,
                                                                index: index,
                                                                layout: "vertical"
                                                            }, blog.id, false, {
...
_s1(BlogListingContent, "7rBQnSEl6YysLig+GyOuKkNviCc=", false, function() {
    return [
...
const BlogListingPage = ({ initialCategory = null })=>{
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BlogListingContent, {
...
__turbopack_context__.k.register(_c1, "HeroFeaturedCard");
__turbopack_context__.k.register(_c2, "HeroSideCard");
__turbopack_context__.k.register(_c3, "BlogListingContent");
__turbopack_context__.k.register(_c4, "BlogListingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_ad500af4._.js.map