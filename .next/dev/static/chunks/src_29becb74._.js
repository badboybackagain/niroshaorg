...
"[project]/src/components/DotGridBackground.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const DotGridBackground = ({ dotSize = 2, gap = 30, color = 'rgba(255, 255, 255, 0.1)', hoverColor = 'rgba(255, 255, 255, 0.3)', hoverRadius = 80, className = '' })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DotGridBackground.useEffect": ()=>{
            const container = containerRef.current;
            if (!container) return;
            const createDots = {
                "DotGridBackground.useEffect.createDots": ()=>{
          ...
          `;
            ...
            const updateDots = {
                "DotGridBackground.useEffect.updateDots": ()=>{
                    ...
                    dotsRef.current.forEach({
                        "DotGridBackground.useEffect.updateDots": (dot)=>{
                            ...
                            if (distance < hoverRadius) {
                                ...
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to(dot.element, {
            ...
            const handleMouseMove = {
                "DotGridBackground.useEffect.handleMouseMove": (e)=>{
                    mousePosition.current = {
                        x: e.clientX,
                        y: e.clientY
                    };
                }
            }["DotGridBackground.useEffect.handleMouseMove"];
            const handleMouseLeave = {
                "DotGridBackground.useEffect.handleMouseLeave": ()=>{
                    mousePosition.current = {
                        x: -1000,
                        y: -1000
                    };
            ...
            const initTimeout = setTimeout({
                "DotGridBackground.useEffect.initTimeout": ()=>{
                    const rect = container.getBoundingClientRect();
                    if (rect.width > 0 && rect.height > 0) {
                        createDots();
                        updateDots();
                        ...
                        }["DotGridBackground.useEffect.initTimeout"], 200);
                    }
                }
            }["DotGridBackground.useEffect.initTimeout"], 100);
            // Event listeners
...
_s(DotGridBackground, "U2f6g1FuVAR6HcqDm0005cW38Ek=");
_c = DotGridBackground;
const __TURBOPACK__default__export__ = DotGridBackground;
var _c;
__turbopack_context__.k.register(_c, "DotGridBackground");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/page-components/ServicesPage.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DotGridBackground$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/DotGridBackground.jsx [app-client] (ecmascript)");
;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                ...
                children: (serviceItemsMap[slug] || []).map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        children: item
                    }, idx, false, {
                        fileName: "[project]/src/page-components/ServicesPage.jsx",
                        lineNumber: 73,
...
const ServicesPage = ()=>{
    ...
    const allServices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ServicesPage.useMemo[allServices]": ()=>{
            return Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$servicesData$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["servicesData"]).map({
                "ServicesPage.useMemo[allServices]": ([slug, data])=>({
                        ...data,
                        slug
                    })
            }["ServicesPage.useMemo[allServices]"]);
        ...
        "ServicesPage.useMemo[filteredServices]": ()=>{
            ...
            return allServices.filter({
                "ServicesPage.useMemo[filteredServices]": (service)=>{
                    ...
                    if (service.detailedItems?.some({
                        "ServicesPage.useMemo[filteredServices]": (item)=>typeof item === 'string' && item.toLowerCase().includes(query)
                    }["ServicesPage.useMemo[filteredServices]"])) return true;
                    // Search in benefits
                    if (service.benefits?.some({
                        "ServicesPage.useMemo[filteredServices]": (benefit)=>typeof benefit === 'string' && benefit.toLowerCase().includes(query)
                    }["ServicesPage.useMemo[filteredServices]"])) return true;
    ...
    const [benefitsRef, benefitsVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useScrollAnimation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScrollAnimation"])({
        threshold: 0.2
    });
    const [gridRef, gridVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useScrollAnimation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScrollAnimation"])({
        threshold: 0.1
    });
            ...
            children: [
                !searchQuery && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DotGridBackground$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            dotSize: 4,
                            gap: 30,
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fi$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FiCheckCircle"], {
                                                style: {
                                                    marginRight: '8px'
                                                }
                                            }, void 0, false, {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "services-hero-benefit-item",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fi$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FiUsers"], {
                                                        className: "benefit-icon"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/page-components/ServicesPage.jsx",
                                                        lineNumber: 199,
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            filteredServices.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: filteredServices.map((service, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ServiceCard, {
                                        service: service,
                                        index: index,
                                        slug: service.slug
                                    }, service.slug, false, {
                                ...
                                lineNumber: 245,
                                columnNumber: 15
                            }, ("TURBOPACK compile-time value", void 0)) : searchQuery ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(ServicesPage, "8pospQ/WpxYXErPG0v0vmF18JiI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useScrollAnimation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScrollAnimation"],
...
//# sourceMappingURL=src_29becb74._.js.map