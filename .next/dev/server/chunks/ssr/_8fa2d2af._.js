...
;
;
const LaptopMockup = ({ imageSrc, alt = "Website Mockup", autoScroll = false, zoom = 1 })=>{
    ...
    const calculateScrollDistance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
    ...
    const handleMouseEnter = ()=>{
        if (autoScroll) return; // Disable hover if autoScroll is active
        setIsHovered(true);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const startLoop = ()=>{
            if (!isActive) return;
            // 1. Start at top (ensure reset)
            setTranslateY('0px');
            // 2. Wait a moment, then scroll down
            timeoutId = setTimeout(()=>{
                if (!isActive) return;
                const distance = calculateScrollDistance();
                if (distance > 0) {
                    setTranslateY(`-${distance}px`);
                    // 3. Wait for scroll down transition (assuming approx 5s from CSS or calculation)
                    // We'll wait 6s to be safe + 2s pause at bottom
                    timeoutId = setTimeout(()=>{
                        if (!isActive) return;
                        // 4. Scroll back up
                        setTranslateY('0px');
                        // 5. Wait for scroll up transition + pause at top, then restart
                        timeoutId = setTimeout(startLoop, 6000);
                    }, 7000);
                } else {
                    // Image loaded late? Retry
                    timeoutId = setTimeout(startLoop, 1000);
                }
            }, 1000);
        };
        // Initialize: wait for image load event if possible, or just optional delay
    ...
    // Update transition duration dynamically if needed? 
    // For now we rely on CSS, but if autoScroll is true, we might want a linear slow scroll.
    // The CSS has `transition: transform 5s linear`.
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Image, {
                                ...
                                style: {
                                    ...
                                    transition: autoScroll ? 'transform 10s linear' : undefined,
                                    width: `${zoom * 100}%`,
                                    height: 'auto',
                                    maxWidth: 'none',
                                    marginLeft: `${(zoom - 1) * -50}%`,
                                    objectFit: 'cover'
                                }
                            }, void 0, false, {
                                fileName: "[project]/src/components/LaptopMockup.jsx",
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ref: containerRef,
                    className: "jsx-c8ba1c1739966578" + " " + "container",
                    children: websites && websites.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-c8ba1c1739966578" + " " + "websites-grid",
                        children: websites.map((site)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_8fa2d2af._.js.map