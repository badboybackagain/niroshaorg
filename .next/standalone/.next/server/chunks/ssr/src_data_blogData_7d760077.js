module.exports=[41102,43974,a=>{"use strict";let b=[{id:1,slug:"logo-designing-with-numerology-and-astrology",title:"Logo Designing with Numerology and Astrology: Creating Brand Identity Through Cosmic Alignment",excerpt:"Discover how combining numerology and astrology principles with professional logo design can create powerful, meaningful brand identities that resonate with your target audience and align with cosmic energies.",category:"Branding & Design",author:"Team Nirosha",publishDate:"2024-01-15",readTime:"8 min read",featuredImage:"/cache/blog/logo-numerology-astrology-featured.webp",imageAlt:"Logo design incorporating numerology and astrology elements",imageSlug:"logo-numerology-astrology",featured:!0,content:`
    ...
    `,seoTitle:"Will Google Penalize AI Content? What Google Says & How to Publish Safely",seoDescription:"Learn whether Google penalizes AI-written content, read Google's own guidance, and follow 8 practical rules to use AI without hurting your SEO. Discover what Google actually says about AI-generated content and how to use it safely.",seoKeywords:"Google AI content penalty, AI generated content Google, does Google penalize AI content, AI content SEO, Google AI content guidelines, AI written content Google, ChatGPT SEO, AI content ranking, Google AI content policy, AI content best practices, Google search AI content, AI content strategy, SEO AI content, Google penalties AI, AI content optimization"}];a.s(["blogCategories",0,["Web Development","Branding & Design","SEO Services","Local SEO","Social Media Marketing","Digital Marketing","Content Services","E-commerce Solutions","Web Maintenance","UI/UX Design","Automation & SaaS","Cloud & Infrastructure"],"blogPosts",0,b,"getBlogBySlug",0,a=>b.find(b=>b.slug===a),"getBlogsByCategory",0,a=>b.filter(b=>b.category===a),"getFeaturedBlogs",0,(a=3)=>b.filter(a=>!0===a.featured).sort((a,b)=>new Date(b.publishDate)-new Date(a.publishDate)).slice(0,a)],41102);var c=a.i(87924),d=a.i(72131);a.s(["default",0,({slug:a,size:b="featured",alt:e,className:f=""})=>{let[g,h]=(0,d.useState)(!1),i={thumbnail:{width:400,height:300,sizes:"(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw"},featured:{width:1200,height:630,sizes:"(max-width: 768px) 100vw, (max-width: 1200px) 90vw, 1200px"},large:{width:1600,height:900,sizes:"100vw"}},j=i[b]||i.featured,k=a||"logo-numerology-astrology";return g?(0,c.jsx)("div",{className:`blog-image-placeholder ${f}`,children:(0,c.jsx)("span",{children:"Image not available"})}):(0,c.jsxs)("picture",{className:f,children:[(0,c.jsx)("source",{srcSet:`
          /cache/blog/${k}-${b}.webp 1x,
          /cache/blog/${k}-${b}@2x.webp 2x
        `,type:"image/webp",onError:()=>h(!0)}),(0,c.jsx)("source",{srcSet:`
          /cache/blog/${k}-${b}.png 1x,
          /cache/blog/${k}-${b}@2x.png 2x
        `,type:"image/png",onError:()=>h(!0)}),(0,c.jsx)("img",{src:`/cache/blog/${k}-${b}.webp`,alt:e||"Blog image",width:j.width,height:j.height,sizes:j.sizes,loading:"lazy",onError:()=>h(!0),className:"blog-image"})]})}],43974)}];

//# sourceMappingURL=src_data_blogData_7d760077.js.map