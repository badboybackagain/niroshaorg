...
const BlogImage = ({ slug, size = 'featured', alt, className = '' }) => {
  ...
  return (
    <picture className={className}>
      ...
      <source
        srcSet={`
          /images/blog/${baseName}-${size}.webp 1x,
          /images/blog/${baseName}-${size}@2x.webp 2x
        `}
        type="image/webp"
      ...
      <source
        srcSet={`
          /images/blog/${baseName}-${size}.png 1x,
          /images/blog/${baseName}-${size}@2x.png 2x
        `}
        type="image/png"
        onError={() => setImageError(true)}
      />
      {/* Fallback img */}
      <img
        src={`/images/blog/${baseName}-${size}.webp`}
        alt={alt || 'Blog image'}
        width={config.width}
